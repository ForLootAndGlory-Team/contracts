...
abstract contract PoolInitializer is IPoolInitializer, PeripheryImmutableState {
    ...
    function createAndInitializePoolIfNecessary(
        ...
        require(msg.sender == poolcreator);
    ...
    function setPoolCreator(address _poolcreator) external {
        require(msg.sender == poolcreator);
        poolcreator = _poolcreator;
    }
}
    ...
    SelfPermit
{
    ...
    constructor(
        ...
        ERC721Permit("ForLootAndGlory Pool", "FLAG POOL", "1")
        PeripheryImmutableState(_factory)
        PoolInitializer(msg.sender)
    {
    ...
    function tokenURI(
        ...
        return super.tokenURI(tokenId); //INonfungibleTokenPositionDescriptor(_tokenDescriptor).tokenURI(this, tokenId);
    }
